...
(function(h) {
    ...
    function La(a, b) {
        ...
        if (c) {
            var e = a.rowIdFn(d);
            e && (c.id = e);
            d.DT_RowClass && (e = d.DT_RowClass.split(" "), b.__rowc = b.__rowc ? pa(b.__rowc.concat(e)) :e, 
    ...
    function Fa(a) {
        ...
        for (m = 0; m < i.length; m++) o = c[i[m]], null !== o.sWidth && (o.sWidth = Fb(o.sWidthOrig, k), 
        t = !0);
        ...
        null !== i && (c[i].sWidth = x(n.eq(m).width())); else {
            ...
            for (m = 0; m < i.length; m++) o = c[i[m]], n[m].style.width = null !== o.sWidthOrig && "" !== o.sWidthOrig ? x(o.sWidthOrig) :"", 
    ...
    function Va(a, b, c, d) {
        ...
        c && a.oFeatures.bSortMulti ? (c = h.inArray(b, G(e, "0")), -1 !== c ? (b = g(e[c], !0), 
    ...
    function L(a, b, c, d) {
        ...
        if (b) D.console && console.log && console.log(c); else if (b = m.ext, b = b.sErrMode || b.errMode, 
    ...
    var m = function(a) {
        ...
        this.each(function() {
            ...
            if ("table" != this.nodeName.toLowerCase()) L(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2); else {
                ...
                gb(o);
                i = o.oClasses;
                e.bJQueryUI ? (h.extend(i, m.ext.oJUIClasses, e.oClasses), e.sDom === l.sDom && "lfrtip" === l.sDom && (o.sDom = '<"H"lfr>t<"F"ip>'), 
                ...
                null !== e.iDeferLoading && (o.bDeferLoading = !0, g = h.isArray(e.iDeferLoading), 
                o._iRecordsDisplay = g ? e.iDeferLoading[0] :e.iDeferLoading, o._iRecordsTotal = g ? e.iDeferLoading[1] :e.iDeferLoading);
                var r = o.oLanguage;
        ...
        b = null;
        return this;
    }, v, r, p, s, Ya = {}, Ob = /[\r\n]/g, Aa = /<.*?>/g, ac = /^[\w\+\-]/, bc = /[\w\+\-]$/, cc = RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\|\\$|\\^|\\-)", "g"), Xa = /[',$拢鈧�%\u2009\u202F\u20BD\u20a9\u20BArfk]/gi, M = function(a) {
        return !a || !0 === a || "-" === a ? !0 :!1;
    }, Pb = function(a) {
        var b = parseInt(a, 10);
        ...
        iterator:function(a, b, c, d) {
            ...
            for (h = l.length; g < h; g++) {
                ...
                f !== k && e.push(f); else if ("column" === b || "column-rows" === b || "row" === b || "cell" === b) {
                    ...
                    i = 0;
                    for (n = t.length; i < n; i++) f = t[i], f = "cell" === b ? c.call(o, l[g], f.row, f.column, g, i) :c.call(o, l[g], f, g, i, m), 
                    f !== k && e.push(f);
                }
            }
